...
if __name__ == "__main__":
    ...
    if (not os.path.exists(os.path.join(map_out_path, "detection-results/"))) and map_mode == 0 or map_mode == 1 or map_mode == 3:
        os.makedirs(os.path.join(map_out_path, 'detection-results'))
        os.makedirs(os.path.join(map_out_path, 'images-optional'))
        print("Load model.")
        frcnn = FRCNN(model_path = './logs/ep100-loss0.653-val_loss1.342.pth', confidence = 0.01, nms_iou = 0.5)
    ...
    if (not os.path.exists(os.path.join(map_out_path, "ground-truth/"))) and map_mode == 0 or map_mode == 3 or map_mode == 2:
